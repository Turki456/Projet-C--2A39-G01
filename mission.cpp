...
bool Mission::ajouter(){
    ...
    QString NBR_string=QString::number(NBR_DE_PERSONES);
                              ...
                              query.prepare("insert into MISSION (ID,DATE_DEBUT_M,NBR_DE_PERSONES,DESTINATION,BUDGET,DATE_FIN_M,TYPE_DE_MISSION) "
                                            "values (:ID,:DATE_DEBUT_M,:NBR_DE_PERSONES,:DESTINATION,:BUDGET,:DATE_FIN_M,:TYPE_DE_MISSION)");
